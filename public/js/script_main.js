...
var constructorMenu = document.getElementById('constructor-menu'); //кнопки на dive авторизации

var loginBtn = document.getElementById('login-button');
var loginDiv = document.getElementById('login-div');
var loginDivCloseBtn = document.getElementById('close-login-div');
var loginDivWrapper = document.getElementById('login-div-wrapper');
var sidebarLoginBtn = document.getElementById('sidebar-login-btn');
var scrolling = false; //Event listener для круглой кнопки login, которая вызывает showLogin и открывается login-div
...
loginDivCloseBtn.addEventListener('click', function () {
  closeLoginDiv();
