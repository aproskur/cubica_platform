<div class="page-main-header">
  <div class="main-header-right row m-01">
    ...
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menu top-navmenu navigation">
        ...
        <li class="onhover-dropdown p-0">
          <button class="btn btn-primary-light" type="button"><a href="#"><i data-feather="log-in"></i>Вход</a></button>
        </li>
        <li class="p-0">
          <button class="btn btn-primary-light" type="button"><a href='signup'><i data-feather="user-plus"></i>Регистрация</a></button>
        </li>
      </ul>
