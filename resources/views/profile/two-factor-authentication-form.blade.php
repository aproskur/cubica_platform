<x-jet-action-section>
    ...
    <x-slot name="content">
        <h3 class="text-lg font-medium text-txtDark bg-bgrdark">
            @if ($this->enabled)
        ...
        <div class="mt-3 max-w-xl text-sm text-txtDark bg-bgrdark">
            <p>
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-txtDark">
