<nav x-data="{ open: false }" class="bg-bgrdark border-b border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl ml-0 mx-auto pl-4 sm:px-6 lg:px-1">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center text-txtDark">
                    <a href="{{ route('main') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Личный кабинет стр 1') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('profile.show') }}" :active="request()->routeIs('profle.show')">
                        {{ __('Личный кабинет стр 2') }}
                    </x-jet-nav-link>
                </div>
            </div>
