    ...
    <header class="main-nav">
      ...
      <div class="m-t-30 launch-link-generator-container llc" id="llc">
          <div class="col-12" style="align-self:center;">
            <h2 class="launch-heading" style="color:var(--theme-yellow);">Настройка запуска игры через ссылки</h2>
          </div>
          ...
          <div id="static-container" class="container-fluid">
            @foreach ($links as $link)
            @if ($link->archived === 0)
            <form class="main-form">
              @csrf
              @method('PUT')
               <div class="launch-link-generator">
                  <div class="switcher-alias">
                    <div class="switcher">
                      <div>
                     <label class="switch">
                ...
                <div class="date-launches">
                      <div class="launches-container">
                        <select name="launches" class="trigger launches form-select digits launch-quantity-selector" data-bs-toggle="tooltip" data-bs-placement="top" title="Количество запусков">
                          <option class="quantity" value="{{ $link->launch_quantity }}"> {{ $link->launch_quantity === null ? html_entity_decode('&infin;') : $link->launch_quantity }} </option>
                    ...
                    <div class="launch-controls nodisplay">
                      <div class=" js-launch-buttons">
                        <a class="theme-button theme-button-square" href="#">
                      ...
                      <div class="theme-button theme-button-square | button-copy-link js-launch-buttons">
                    ...
                    <div class="share-div-container theme-button theme-button-square | button-share-link js-launch-buttons">
                    ...
                    <div class="theme-button theme-button-square archive-link | button-archive-link js-launch-buttons">
              ...
              <div id="static-container-archive" class="container-fluid">
                @foreach ($links as $link)
                @if ($link->archived === 1)
                <div class="wrapper">
                  <div class="archive-links-container">
                    <div class="archive-container-icon">
                      <div>
                    ...
                    <div class="archived-link">
                      ...
                      <div class="archive-controls">  
                        <div class="theme-button theme-button-square | button-arch-copy nodisplay" data-bs-toggle="tooltip" data-bs-placement="top" title="Копировать">
                          <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                        </div>
                      </div>
                  </div>
