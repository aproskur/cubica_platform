    ...
    <div class="page-body">
      ...
      <div class="container m-t-50 launch-link-generator-container">
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-6 d-flex flex-row-reverse">
              <div class="animated-link" style="margin-right:35px;">
                <a class="" href="#">Перейти в админку игры</a>
              </div>
            </div>
          </div>
        ...
        <div class="row m-t-30 launch-link-generator">
            ...
            <div class="col-sm-2 launch-link-generator__icons" style="gap:2rem; display:flex;">
              <div class="">
